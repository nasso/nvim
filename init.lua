...
-- Remap jk/kj to exit insert mode
...
-- Remap <C-[hjkl]> to move around windows
...
-- Remap <leader>z to toggle zen mode
vim.keymap.set({ 'n', 'v' }, '<leader>z', require('zen-mode').toggle, { desc = 'Toggle Zen Mode' })
